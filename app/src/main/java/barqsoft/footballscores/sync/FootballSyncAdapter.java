...
import barqsoft.footballscores.MyApp;
...
public class FootballSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getData (String timeFrame)
    {
        ...
        try {
            ...
            m_connection.addRequestProperty("X-Auth-Token",MyApp.getContext().getString(R.string.api_key));
        ...
        try {
            if (JSON_data != null) {
                ...
                if (matches.length() == 0) {
                    ...
                    processJSONdata(MyApp.getContext().getString(R.string.dummy_data), MyApp.getContext().getApplicationContext(), false);
                    return;
                }


                processJSONdata(JSON_data, MyApp.getContext().getApplicationContext(), true);
            } else {
                //Could not Connect
